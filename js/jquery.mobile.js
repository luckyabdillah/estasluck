    ...
    (function (e, t, n, r) {
        ...
        function N(t, n) {
            var i = t.type,
                ...
                d,
                v;
            (t = e.Event(t)), (t.type = n), (s = t.originalEvent), (o = []), i.search(/^(mouse|click)/) > -1 && (o = f);
            ...
            return {
                setup: function () {
                    ...
                    (r[t] = !0),
                        ...
                        l[t] === 1 && b.on(n, H),
                        e(this).on(n, R),
                        y && ((l.touchstart = (l.touchstart || 0) + 1), l.touchstart === 1 && b.on("touchstart", B).on("touchend", I).on("touchmove", F).on("scroll", j));
                },
                teardown: function () {
                    --l[t], l[t] || b.off(n, H), y && (--l.touchstart, l.touchstart || b.off("touchstart", B).off("touchmove", F).off("touchend", I).off("scroll", j));
                    var r = e(this),
                        s = e.data(this, i);
                    s && (s[t] = !1), r.off(n, R), q(this) || r.removeData(i);
                },
            };
        }
                ...
                (e.event.special.tap = {
                    ...
                    setup: function () {
                        ...
                        n.on("vmousedown", function (s) {
                            ...
                            function f() {
                                a(), n.off("vclick", c).off("vmouseup", a), i.off("vmousecancel", f);
                            }
                            function c(e) {
                    ...
                    teardown: function () {
                        e(this).off("vmousedown").off("vclick").off("vmouseup"), i.off("vmousecancel");
                    },
                }),
