    ...
    $(document).ready(function () {
        ...
        $("div.ays-pb-modals").each(function () {
            ...
            $(document)
                ...
                .on("click", function () {
                    $(document)
                        .find("input#ays-pb-modal-checkbox_" + id)
                        .trigger("change");
                });
        ...
        function setCloseButtonPosition(template, id, height, minHeight, borderSize, enableFullScreen, closeButtonPosition) {
            ...
            if (template == "default") {
                ...
                var h2Height = $(document)
                    .find(".ays-pb-modal_" + id + " h2")
                    .outerHeight(true);
                var hrHeight = $(document)
                    .find(".ays-pb-modal_" + id + " hr")
                    .outerHeight(true);
                var descriptionHeight = $(document)
                    .find(".ays-pb-modal_" + id + " .ays_pb_description")
                    .outerHeight(true);
                var timerHeight = $(document)
                    .find(".ays-pb-modal_" + id + " .ays_pb_timer_" + id)
                    .outerHeight(true);
                var customHtml = $(document)
                    .find(".ays-pb-modal_" + id + " .ays_content_box")
                    .outerHeight(true);
            ...
            $(document)
                .find(".ays-pb-modal_" + id + " .ays-pb-modal-close_" + id)
